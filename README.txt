...
Toteutan työn Maven Java-projektina. Ohjelma käyttää laskennassa H2 tietokantaa Spring sovelluskehyksen ja JDBC-rajapinnan kautta. Ohjelman käynnistyessä, ohjelma tarkistaa löytyykö tietokanta ”elakelaskuri” ja tarvittavat taulut kansiosta /ElakelaskuriSovellus. Jos ei löydy, ohjelma luo ne ja datan. Tietokantaa käytetään ikäluokkakohtaisten eläkeikien ja elinaikakertoimien säilyttämiseen/lukemiseen. Tarvittaessa ohjelmaa voi laajentaa siten, että tietokantaan tallennetaan myös esimerkiksi henkilöt ja laskelmat.
